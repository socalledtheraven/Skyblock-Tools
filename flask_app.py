...
@app.route("/api")
def api():
    return redirect(f"https://api.{URL}/docs")


@app.route("/bazaar_flipper", methods=["GET", "POST"])
def bazaar_flipper():
    main.build_table(main.bazaar_flipper(),
...
def craft_flipper():
    main.build_table(main.craft_flipper(),
...
def forge_flipper():
    main.build_table(main.forge_flipper(),
